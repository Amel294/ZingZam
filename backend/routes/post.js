...
const { postPhoto,getPosts,addComment,saveUnsavePost,likeUnlikePost,commentsFromPostId,deleteComment, LikedUsers, getComments, getReplies,changeCaption, getProfilePosts  } = require('../controllers/postController');
